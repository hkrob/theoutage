-- Migration: 0006_admin_create_user.sql
-- TheOutage — widen moderation_log.action to include 'create_user', for
-- accounts an admin creates directly from the admin page.
-- Apply with: wrangler d1 execute theoutage-db --remote --file=migrations/0006_admin_create_user.sql
...
-- migrations 0005's comment for the full explanation).
