-- Migration: 0003_severity_p_levels.sql
-- TheOutage — rename severity levels low/medium/high -> P3/P2/P1
...
-- Apply with: wrangler d1 execute theoutage-db --remote --file=migrations/0003_severity_p_levels.sql
...
CREATE TABLE outages_new (
  ...
  end_time          TEXT,
  severity          TEXT NOT NULL CHECK (severity IN ('P3', 'P2', 'P1')),
  source_url        TEXT,
